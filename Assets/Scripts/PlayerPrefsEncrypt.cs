...
namespace JastSent{
	 ...
	 */
		private static string ULTRAKey = "motkaselka";
		private static byte[] key = new byte[8] {66, 57, 33, 244, 78, 97, 81, 74};
		private static byte[] iv = new byte[8] {78, 89, 97, 51, 44, 24, 19, 175};
		...
		private static string md5(string s) {
			byte[] hashBytes = new MD5CryptoServiceProvider().ComputeHash(new UTF8Encoding().GetBytes(s + ULTRAKey + SystemInfo.deviceUniqueIdentifier));
			string hashString = "";
