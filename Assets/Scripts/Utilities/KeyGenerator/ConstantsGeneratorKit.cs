#define DISABLE_AUTO_GENERATION//comment for auto re-generation scripts
#if UNITY_EDITOR
using UnityEngine;
using UnityEditor;
using System;
...
namespace JastSent.Editor.Utilities
{
	...
	public class ConstantsGeneratorKit : MonoBehaviour
	{
		...
		//private static string NAMESPACE = "Keys"; //set to "" for disable namespace
		...
		private static bool buildResources = false; 
		private static bool buildScenes = false; 
		private static bool buildTags = true; 
		private static bool buildLayers = false; 
		private static bool buildSortingLayers = false;
		...
		public static void rebuildConstantsClasses()
		{
			...
			if( SHOW_SUCCESS_MESSAGE && buildResources && buildScenes && buildTags && buildLayers )
	...
	public class ConstandsGeneratorPostProcessor : AssetPostprocessor
	{
		...
		static void OnPostprocessAllAssets( string[] importedAssets, string[] deletedAssets, string[] movedAssets, string[] movedFromAssetPaths )
		{
			...
			if( resourcesDidChange )
				ConstantsGeneratorKit.rebuildConstantsClasses();
